...
NPreferencesDialogHandler::NPreferencesDialogHandler(NPlayer *player, QObject *parentWindow)
    : NDialogHandler(NCore::qmlUrl("preferencesDialog.qml"), parentWindow)
{
    m_player = player;
    ...
    connect(this, &NDialogHandler::setupContext, [this](QQmlContext *context) {
        ...
        { // encodings
            ...
            context->setContextProperty("NEncodingModel", QVariant::fromValue(data));
        }
        ...
        { // plugins
            ...
            context->setContextProperty("NPluginModel", QVariant::fromValue(data));
        }
