...
Rectangle {
  ...
  property color toggleSvgOverlay: lightTheme ? "#663D3D3D" : "#66FFFFFF"
  ...
  Rectangle {
    ...
    visible: mainWindow.visibility !== Window.Maximized && mainWindow.visibility !== Window.FullScreen
    z: 1
  }
  ...
  Connections {
    ...
    function onAboutToQuit() {
      ...
      NSettings.setValue(settingsPrefix + "LightTheme", lightTheme);
    }
  }
        ...
        ColumnLayout {
          ...
          RowLayout {
            ...
            NCoverImage {
              ...
              Rectangle {
                anchors.fill: parent
                border.color: lightTheme ? "#1FAEFF" : "#252526"
                color: "transparent"
              }
