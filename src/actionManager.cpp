...
NActionManager::NActionManager(NPlayer *player) : QObject(player)
{
...

    {
        ...
        connect(repeatPlaylistAction, &NAction::triggered, player->playlistController(),
                &NPlaylistController::setRepeatMode);
        connect(player->playlistController(), &NPlaylistController::repeatModeChanged,
                repeatPlaylistAction, &NAction::setChecked);
        repeatPlaylistAction->setChecked(player->playlistController()->repeatMode());
