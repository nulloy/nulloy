...
{
    Q_OBJECT
    Q_PROPERTY(int rowsPerPage READ rowsPerPage WRITE setRowsPerPage)
    Q_PROPERTY(int firstVisibleRow READ firstVisibleRow WRITE setFirstVisibleRow)
    Q_PROPERTY(bool repeatMode READ repeatMode WRITE setRepeatMode NOTIFY repeatModeChanged)
